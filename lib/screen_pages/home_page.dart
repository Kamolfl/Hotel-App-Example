...
class _HomePageState extends State<HomePage> {
        ...
        builder: (BuildContext context, AsyncSnapshot snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return SingleChildScrollView(
              child: Column(
                children: [
                  _carouselOfPhotos(hotelData),
                  _basicInformationAboutTheHotel(hotelData),
                  _detailInformationHotel(hotelData),
  ...
  Widget _carouselOfPhotos(Map<String, dynamic> hotelData) {
  ...
  Widget _basicInformationAboutTheHotel(Map<String, dynamic> hotelData) {
    double sidePadding = MediaQuery.of(context).size.width * 0.05;
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: sidePadding),
      child: Column(
  ...
  Widget _detailInformationHotel(Map<String, dynamic> hotelData) {
    double sidePadding = MediaQuery.of(context).size.width * 0.05;
    return Column(
      children: [
        const SizedBox(height: 10),
